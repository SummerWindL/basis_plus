package com.ygzc.web.controller.index;
...
import com.ygzc.dao.model.index.MenuModel;
...
public class IndexController extends BaseController {
    ...
    public List<MenuModel> menu(@PathVariable String roleId) {
        if ("admin".equals(this.getSessionUser().getUserType())) {
            ...
            List<MenuModel> rootList = delegateService.selectList("com.ygzc.dao.mapper.index.IndexCustomMapper.getMenu", paramMap);
    ...
    private List<MenuModel> getMenu(String pid, String roleId) {
        ...
        List<MenuModel> list = new ArrayList<>();
        List<MenuModel> menuList = delegateService.selectList("com.ygzc.dao.mapper.index.IndexCustomMapper.getMenu", paramMap);
