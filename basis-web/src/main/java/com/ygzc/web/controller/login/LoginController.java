...
import com.ygzc.dao.model.login.LoginUser;
...
public class LoginController extends BaseController {
    ...
    public LoginModel signin(String username, String password, boolean remember) {
        ...
        LoginUser loginUser = delegateService.selectOne("com.ygzc.dao.mapper.login.LoginCustomMapper.getLoginUser", paramMap);
        ...
        List<Map<String, Object>> userRoles = delegateService.selectList("com.ygzc.dao.mapper.login.LoginCustomMapper.getUserRoles", loginUser.getUserId());
