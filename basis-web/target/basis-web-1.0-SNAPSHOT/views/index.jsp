	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>该项目是<a href="/yan-demo" target="_blank">yan-demo</a>单节点项目的升级版，支持分布式，持续更新中，敬请期待...</b></p>
				<p><b>代码已托管至<a href="/yan" target="_blank"> github</a>，目前正在不断完善，敬请期待...</b></p>
				<p>Created by Yanzheng Since 2017</p>
				<p>Copyright <a href="" target="_blank"></a>. All rights reserved.</p>
			</div>
		</div>
	</section>
</section>
